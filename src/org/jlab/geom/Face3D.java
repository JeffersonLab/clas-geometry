...
public class Face3D {
    ...
    public final void set(double x1, double y1, double z1,
        ...
        Vector3D vec_a = Point3D.getDirVector(points[0], points[1]);
        Vector3D vec_b = Point3D.getDirVector(points[0], points[2]);
        surfaceNormal  = vec_a.cross(vec_b);
        surfaceNormal.unit();
    }
    /**
    ...
    /**
     * Returns the normal vector to the surface.
     * @return Vector3D object = (P1-P0)x(P2-P0), (P0,P1 and P2 points of the triangle)
     */
